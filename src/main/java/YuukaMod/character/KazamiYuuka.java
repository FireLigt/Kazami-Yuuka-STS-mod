package YuukaMod.character;

import YuukaMod.Yuukamod;
import YuukaMod.cards.basic.Defend;
import YuukaMod.cards.basic.Intimidation;
import YuukaMod.cards.basic.Small_magic_cannon;
import YuukaMod.cards.basic.Strike;
...
import static YuukaMod.Yuukamod.characterPath;
import static YuukaMod.Yuukamod.makeID;

public class KazamiYuuka extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Yuuka"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass FLOWER_FIELD_TYRANT;
        @SpireEnum(name = "YUUKA_SUNFLOWER")
        public static AbstractCard.CardColor YUUKA_COLOR;
        @SpireEnum(name = "YUUKA_SUNFLOWER") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType FLOWERY_LIBRARY;
        ...
        private static final Color cardColor = new Color(0f/255f, 180f/255f, 0f/255f, 1f);

        //Methods that will be used in the main mod file
        public static void registerColor() {
            BaseMod.addColor(YUUKA_COLOR, cardColor,
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new KazamiYuuka(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Intimidation.ID);
        retVal.add(Small_magic_cannon.ID);
    ...
    public AbstractCard.CardColor getCardColor() {
        return Meta.YUUKA_COLOR;
    }

    @Override
    public AbstractPlayer newInstance() {
        //Makes a new instance of your character class.
        return new KazamiYuuka();
    }
}
